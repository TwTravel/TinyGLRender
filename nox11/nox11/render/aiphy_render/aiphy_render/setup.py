...
render_api_src_file_list = ['main.cpp']
render_api_src_file_path_list = [ "aiphy_render/render_api/" + src_file for src_file in render_api_src_file_list]
...
ext_modules = [
    Extension(
        'aiphy_render',
        tinygl_src_file_path_list + render_api_src_file_path_list,
        include_dirs=[
            # Path to pybind11 headers
            get_pybind_include(),
            get_pybind_include(user=True)
        ] + ['aiphy_render/tinygl/include'],
        language='c++'
    ),
]
